...
public class FileUpland {
     ...
     * @throws Exception
     */
    public String uploadFile(MultipartFile newFile, String newFileOriginalName,String oldFileName) throws Exception {
        // 判断文件是否为空
        ...
        minioClient.putObject(PutObjectArgs.builder()
                ...
                .object(objectName)
                .stream(newFile.getInputStream(), newFile.getSize(), -1)
