...
declare namespace App {
  ...
  namespace Global {
    ...
    type RouteKey = import('@/router/types').RouteKey;
    ...
    type Menu = {
       ...
       * The menu key
       *
       * Equal to the route key or menu id
       */
      key: string;
      /** The menu label */
      label: string;
      /** The menu i18n key */
      menuI18nKey?: I18n.I18nKey | null;
      /** The menu type */
      menuType: import('@/menu/definition').AppMenuType;
      /** The route key */
      routeKey: RouteKey;
      /** The route path */
      routePath: string;
      ...
      enabled: boolean;
      /** The menu permission list returned by backend */
      permission?: import('@/menu/definition').MenuPermission[];
      /** The menu icon */
      icon?: () => VNode;
      /** The tooltip title */
      title?: string;
  ...
  namespace Service {
    ...
    type Response<T = unknown> = {
      /** The backend service response success flag */
      success: boolean;
      /** The backend service response data */
      data?: T | null;
      /** The backend service response error code */
