<template>
  <div class="absolute left-0 top-0 z-[1] size-full overflow-hidden">
    <div class="absolute -right-[300px] -top-[900px] max-sm:-right-[100px] max-sm:-top-[1170px]">
    ...
    <div class="absolute -bottom-[400px] -left-[200px] max-sm:-bottom-[760px] max-sm:-left-[100px]">
