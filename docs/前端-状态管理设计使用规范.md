...
2. 再看 [系统前端服务参考.md](file:///Users/yangmufa/UserDevelopment/CSharp/Mint.Blog/docs/系统前端服务参考.md)，确定接口访问边界
3. 再看 [前端-布局参考.md](file:///Users/yangmufa/UserDevelopment/CSharp/Mint.Blog/docs/前端-布局参考.md)，确定壳层边界
