...
const emit = defineEmits<{
  (e: 'clickArticle', id: number): void
  (e: 'clickCategory', id: number, name: string): void
  (e: 'clickTag', id: number, name: string): void
}>()

const getArticleInfo = (article: Article): string => {
  if (article.summary && article.summary.trim().length) return article.summary
...
<style lang="scss" scoped>
  ...
  .bottom .social-buttons-container .social-button {
    ...
    box-shadow: rgba(28, 5, 71, 0.5) 0px 7px 5px -5px;
    cursor: pointer;
    transition:
  ...
  .bottom .social-buttons-container .social-button:hover {
    ...
    box-shadow: rgba(34, 5, 71, 0.4) -5px 15px 10px 0px;
  }
