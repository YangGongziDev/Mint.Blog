...
1. 先看 [系统RESTful接口参考.md](file:///Users/yangmufa/UserDevelopment/CSharp/Mint.Blog/docs/系统RESTful接口参考.md)，确定接口设计
2. 再看 [系统API契约参考.md](file:///Users/yangmufa/UserDevelopment/CSharp/Mint.Blog/docs/系统API契约参考.md)，确定返回体与错误码
3. 再看 [系统认证参考.md](file:///Users/yangmufa/UserDevelopment/CSharp/Mint.Blog/docs/系统认证参考.md)，确定鉴权接入
