...
public sealed class UpdateFriendCommandHandler(IFriendRepository friendRepository) {
	public async Task HandleAsync(UpdateFriendCommand command, CancellationToken cancellationToken = default){
