...
import cn.yangmufa.blog.common.exception.BaseExceptionInterface;
...
public enum ResponseCodeEnum implements BaseExceptionInterface {
    ...
    TAG_CANT_DUPLICATE("20006", "该标签已存在,请勿重复操作！"),
    ...
    SORT_OPERATION_FAILURE_LESS_THAN_ONE("20019", "顺序调整失败,顺序值不能小于1!"),
    RESOURCE_NOT_FOUND("20020", "资源不存在!"),
    WIKI_CANT_DUPLICATE("20021", "该知识库已存在,请勿重复操作！"),
    WIKI_NOT_EXISTED("20022", "该知识库不存在！"),
    ;
    // 异常码
